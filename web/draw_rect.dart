...
void main() {
  ...
  // setup shader
  //
  webgl.Shader vertexShader = hetimagl.loadShader(GL,
  ...
  webgl.Shader fragmentShader = hetimagl.loadShader(GL,
      webgl.RenderingContext.FRAGMENT_SHADER, "precision mediump float;\n" +
          "void main() {\n" +
